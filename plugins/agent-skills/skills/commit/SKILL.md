...
**Even when attribution is opted in, NEVER include any of the following:**
...
`Co-Authored-By` is the only acceptable form of attribution, and only under the opt-in conditions above.
