def render_result(plan, columns, rows):
    ...
    FP guard: both the chart path and the table fallback carry the plan's y_format,
    so a percent measure renders correctly either way. The branches handle the same
    concept consistently — nothing to flag.
    """
